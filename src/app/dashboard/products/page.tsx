...
import ProductPage from "@/components/views/dashboard/products/product-page";
import { getProductsListActionWithQueryAndToken } from "@/lib/actions/product-action";
...
async function Suspended({
  ...
  const response = await getProductsListActionWithQueryAndToken(
