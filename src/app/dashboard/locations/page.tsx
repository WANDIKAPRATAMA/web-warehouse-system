...
import WarehouseLocationPage from "@/components/views/dashboard/locations/locations-page";
import { getWarehouseLocationsListAction } from "@/lib/actions/warehouse-location-action";
...
async function Suspended({
  ...
  const response = await getWarehouseLocationsListAction(
